...
function osm_image_widget_donate($links, $file) {
    if($file == plugin_basename(__FILE__)) {
        $links[] = '<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=6JYWV644JYL7Q&lc=ES&item_name=OSM" target="_blank">' . __('Donate', 'osm-image-widget') . '</a>';
    }
    return $links;
}
add_filter('plugin_row_meta', 'osm_image_widget_donate', 10, 2);
